...
public class CalculoValorLocacaoTest {
	...
	@Parameter(value = 0) //Primeiro registro do Array
	public List<Filme> filmes;
	
	@Parameter(value = 1) //Segundo registro do Array
	...
	private static Filme filme1 = new Filme("Interestelar", 2, 4.0);
	private static Filme filme2 = new Filme("Piratas do Caribe", 2, 4.0);
	private static Filme filme3 = new Filme("Passageiros", 1, 4.0);
	private static Filme filme4 = new Filme("Até que a morte nos separe", 1, 4.0);
